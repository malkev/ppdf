...
- <code>include</code>: contains the [autoloader](#autoloader-namespaces-and-naming-conventions) function. 
- <code>model</code>: contains the base classes for interface with database. See [paragraph](#data-provider) for details. Moreover, here is located the abstract class of MVC model class. [See Class Reference](@ref spf::model::_spfModel).
- <code>modules</code>: contains misc [utility modules](#additional-modules). 
...
- <code>view</code>: contains the MVC view class and relative template classes. See [paragraph](#view-and-templates) for more details.
...
---
## Autoloader, namespaces and naming conventions
